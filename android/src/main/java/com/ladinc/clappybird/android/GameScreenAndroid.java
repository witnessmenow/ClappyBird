...
public class GameScreenAndroid implements Screen 
{
	...
	public GameScreenAndroid(ClappyBirdAndroid clappyBird)
	{		
	...
	private void removePipesOnGameReset() {
		...
		GameScreenAndroid.world.destroyBody(pipe.btmPipe);
		pipe.btmPipe = null;
		GameScreenAndroid.world.destroyBody(pipe.topPipe);
		pipe.topPipe = null;
