...
import com.ladinc.clappybird.core.collision.CollisionInfo.CollisionObjectType;
...
//	}
	...
	private Pipe lastScore;
	public boolean newScore = false;

	public Pipe getLastScored()
	{
		newScore = false;
		return lastScore;
	}
        ...
        if(bodyAInfo != null && bodyBInfo != null)
        {
        			...
        			(bodyAInfo.type == CollisionObjectType.Puck && bodyBInfo.type == CollisionObjectType.ScoreZone))
        	{
        		...
        		if(bodyAInfo.type == CollisionObjectType.ScoreZone)
        			lastScore = bodyAInfo.pipe;
        		else
        			lastScore = bodyBInfo.pipe;
